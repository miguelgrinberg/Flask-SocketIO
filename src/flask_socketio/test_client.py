...
class SocketIOTestClient(object):
    ...
    def connect(
        self, namespace=None, query_string=None, headers=None, auth=None
    ):
        """Connect the client.
        ...
        sid = self.socketio.server.manager.sid_from_eio_sid(
            self.eio_sid, namespace
        )
        if sid:
